...
.Lfunc_begin0:
        .amd_kernel_code_t
                ...
                granulated_workitem_vgpr_count = 20;(v+4-1)/4-1
...
.set vgpr_xor_control_offset_for_fma,50
;//51
.set vgpr_thread_A_4_2nd,52;//52 53 54 55
.set vgpr_thread_B_4_2nd,56;// 56 57 58 59


.set vgpr_thread_A_4_3rd,60;//60 61 62 63
.set vgpr_thread_B_4_3rd,64;// 64 65 66 67

.set vgpr_thread_A_4_4th,68;//68 69 70 71
.set vgpr_thread_B_4_4th,72;// 72 73 74 75

.set vgpr_thread_A_4_5th,76;//76 77 78 79
.set vgpr_thread_B_4_5th,80;// 80 81 82 83
...
BIG_LOOP:
    ...
    s_cmp_gt_u32 s[sgpr_Loop_NOO_start],s[sgpr_NOO_16]
    s_cbranch_scc1 FMA_last;//the end,but you still have 1 FMA not done yet

AB_LOAD_in_loop:

    v_mul_lo_u32 v[vgpr_xor_control_offset],v[vgpr_xor_control],s[sgpr_LDS_switch_offset]

;vgpr_xor_control_offset_for_fma
    v_lshlrev_b32 v9,10,v[vgpr_waveid];//waveid*16*64
    v_lshl_add_u32 v10,v[vgpr_wave_tid],2,v9;//wave tid*4+waveid*16*64
    v_add_u32 v10,v10,v[vgpr_xor_control_offset];//add 0 or 4096 for diff round
...
;//for fma offset
    ...
    v_mul_lo_u32 v[vgpr_xor_control_offset_for_fma],v[vgpr_xor_control],s[sgpr_LDS_switch_offset]
   ;//add 0 or 4096 for switch
    ...
    s_waitcnt     lgkmcnt(0);//wait aux buf at first loop and previous lds write
    ...
    ds_read_b128  v[vgpr_thread_A_4_2nd:vgpr_thread_A_4_2nd+3], v[vgpr_lds_A_offset] offset:0
    ds_read_b128  v[vgpr_thread_B_4_2nd:vgpr_thread_B_4_2nd+3],v[vgpr_lds_B_offset] offset:8192

;//NOO LOOP 2
v_add_u32 v[vgpr_lds_A_offset],v[vgpr_lds_A_offset],s[sgpr_lds_NOO_offset];//64*4 
v_add_u32 v[vgpr_lds_B_offset],v[vgpr_lds_B_offset],s[sgpr_lds_NOO_offset]

ds_read_b128  v[vgpr_thread_A_4_3rd:vgpr_thread_A_4_3rd+3], v[vgpr_lds_A_offset] offset:0
ds_read_b128  v[vgpr_thread_B_4_3rd:vgpr_thread_B_4_3rd+3],v[vgpr_lds_B_offset] offset:8192
...
ds_read_b128  v[vgpr_thread_A_4_4th:vgpr_thread_A_4_4th+3], v[vgpr_lds_A_offset] offset:0
ds_read_b128  v[vgpr_thread_B_4_4th:vgpr_thread_B_4_4th+3],v[vgpr_lds_B_offset] offset:8192
...
ds_read_b128  v[vgpr_thread_A_4_5th:vgpr_thread_A_4_5th+3], v[vgpr_lds_A_offset] offset:0
ds_read_b128  v[vgpr_thread_B_4_5th:vgpr_thread_B_4_5th+3],v[vgpr_lds_B_offset] offset:8192
...
;s_waitcnt     lgkmcnt(0)
;//FMA LOOP1
v_fmac_f32    v[vgpr_FMA_value], v[vgpr_thread_A_4_2nd], v[vgpr_thread_B_4_2nd]
v_fmac_f32    v[vgpr_FMA_value+1],v[vgpr_thread_A_4_2nd+1], v[vgpr_thread_B_4_2nd]
v_fmac_f32    v[vgpr_FMA_value+2],v[vgpr_thread_A_4_2nd+2], v[vgpr_thread_B_4_2nd]
v_fmac_f32    v[vgpr_FMA_value+3],v[vgpr_thread_A_4_2nd+3], v[vgpr_thread_B_4_2nd]
v_fmac_f32    v[vgpr_FMA_value+4], v[vgpr_thread_A_4_2nd], v[vgpr_thread_B_4_2nd+1]
v_fmac_f32    v[vgpr_FMA_value+5],v[vgpr_thread_A_4_2nd+1], v[vgpr_thread_B_4_2nd+1]
v_fmac_f32    v[vgpr_FMA_value+6],v[vgpr_thread_A_4_2nd+2], v[vgpr_thread_B_4_2nd+1]
v_fmac_f32    v[vgpr_FMA_value+7],v[vgpr_thread_A_4_2nd+3], v[vgpr_thread_B_4_2nd+1]
v_fmac_f32    v[vgpr_FMA_value+8], v[vgpr_thread_A_4_2nd], v[vgpr_thread_B_4_2nd+2]
v_fmac_f32    v[vgpr_FMA_value+9],v[vgpr_thread_A_4_2nd+1], v[vgpr_thread_B_4_2nd+2]
v_fmac_f32    v[vgpr_FMA_value+10],v[vgpr_thread_A_4_2nd+2], v[vgpr_thread_B_4_2nd+2]
v_fmac_f32    v[vgpr_FMA_value+11],v[vgpr_thread_A_4_2nd+3], v[vgpr_thread_B_4_2nd+2]
v_fmac_f32    v[vgpr_FMA_value+12], v[vgpr_thread_A_4_2nd], v[vgpr_thread_B_4_2nd+3]
v_fmac_f32    v[vgpr_FMA_value+13],v[vgpr_thread_A_4_2nd+1], v[vgpr_thread_B_4_2nd+3]
v_fmac_f32    v[vgpr_FMA_value+14],v[vgpr_thread_A_4_2nd+2], v[vgpr_thread_B_4_2nd+3]
v_fmac_f32    v[vgpr_FMA_value+15],v[vgpr_thread_A_4_2nd+3], v[vgpr_thread_B_4_2nd+3]
...
;s_waitcnt     lgkmcnt(0)
;//FMA LOOP2
v_fmac_f32    v[vgpr_FMA_value], v[vgpr_thread_A_4_3rd], v[vgpr_thread_B_4_3rd]
v_fmac_f32    v[vgpr_FMA_value+1],v[vgpr_thread_A_4_3rd+1], v[vgpr_thread_B_4_3rd]
v_fmac_f32    v[vgpr_FMA_value+2],v[vgpr_thread_A_4_3rd+2], v[vgpr_thread_B_4_3rd]
v_fmac_f32    v[vgpr_FMA_value+3],v[vgpr_thread_A_4_3rd+3], v[vgpr_thread_B_4_3rd]
v_fmac_f32    v[vgpr_FMA_value+4], v[vgpr_thread_A_4_3rd], v[vgpr_thread_B_4_3rd+1]
v_fmac_f32    v[vgpr_FMA_value+5],v[vgpr_thread_A_4_3rd+1], v[vgpr_thread_B_4_3rd+1]
v_fmac_f32    v[vgpr_FMA_value+6],v[vgpr_thread_A_4_3rd+2], v[vgpr_thread_B_4_3rd+1]
v_fmac_f32    v[vgpr_FMA_value+7],v[vgpr_thread_A_4_3rd+3], v[vgpr_thread_B_4_3rd+1]
v_fmac_f32    v[vgpr_FMA_value+8], v[vgpr_thread_A_4_3rd], v[vgpr_thread_B_4_3rd+2]
v_fmac_f32    v[vgpr_FMA_value+9],v[vgpr_thread_A_4_3rd+1], v[vgpr_thread_B_4_3rd+2]
v_fmac_f32    v[vgpr_FMA_value+10],v[vgpr_thread_A_4_3rd+2], v[vgpr_thread_B_4_3rd+2]
v_fmac_f32    v[vgpr_FMA_value+11],v[vgpr_thread_A_4_3rd+3], v[vgpr_thread_B_4_3rd+2]
v_fmac_f32    v[vgpr_FMA_value+12], v[vgpr_thread_A_4_3rd], v[vgpr_thread_B_4_3rd+3]
v_fmac_f32    v[vgpr_FMA_value+13],v[vgpr_thread_A_4_3rd+1], v[vgpr_thread_B_4_3rd+3]
v_fmac_f32    v[vgpr_FMA_value+14],v[vgpr_thread_A_4_3rd+2], v[vgpr_thread_B_4_3rd+3]
v_fmac_f32    v[vgpr_FMA_value+15],v[vgpr_thread_A_4_3rd+3], v[vgpr_thread_B_4_3rd+3]
...
;s_waitcnt     lgkmcnt(0)
;//FMA LOOP3
v_fmac_f32    v[vgpr_FMA_value], v[vgpr_thread_A_4_4th], v[vgpr_thread_B_4_4th]
v_fmac_f32    v[vgpr_FMA_value+1],v[vgpr_thread_A_4_4th+1], v[vgpr_thread_B_4_4th]
v_fmac_f32    v[vgpr_FMA_value+2],v[vgpr_thread_A_4_4th+2], v[vgpr_thread_B_4_4th]
v_fmac_f32    v[vgpr_FMA_value+3],v[vgpr_thread_A_4_4th+3], v[vgpr_thread_B_4_4th]
v_fmac_f32    v[vgpr_FMA_value+4], v[vgpr_thread_A_4_4th], v[vgpr_thread_B_4_4th+1]
v_fmac_f32    v[vgpr_FMA_value+5],v[vgpr_thread_A_4_4th+1], v[vgpr_thread_B_4_4th+1]
v_fmac_f32    v[vgpr_FMA_value+6],v[vgpr_thread_A_4_4th+2], v[vgpr_thread_B_4_4th+1]
v_fmac_f32    v[vgpr_FMA_value+7],v[vgpr_thread_A_4_4th+3], v[vgpr_thread_B_4_4th+1]
v_fmac_f32    v[vgpr_FMA_value+8], v[vgpr_thread_A_4_4th], v[vgpr_thread_B_4_4th+2]
v_fmac_f32    v[vgpr_FMA_value+9],v[vgpr_thread_A_4_4th+1], v[vgpr_thread_B_4_4th+2]
v_fmac_f32    v[vgpr_FMA_value+10],v[vgpr_thread_A_4_4th+2], v[vgpr_thread_B_4_4th+2]
v_fmac_f32    v[vgpr_FMA_value+11],v[vgpr_thread_A_4_4th+3], v[vgpr_thread_B_4_4th+2]
v_fmac_f32    v[vgpr_FMA_value+12], v[vgpr_thread_A_4_4th], v[vgpr_thread_B_4_4th+3]
v_fmac_f32    v[vgpr_FMA_value+13],v[vgpr_thread_A_4_4th+1], v[vgpr_thread_B_4_4th+3]
v_fmac_f32    v[vgpr_FMA_value+14],v[vgpr_thread_A_4_4th+2], v[vgpr_thread_B_4_4th+3]
v_fmac_f32    v[vgpr_FMA_value+15],v[vgpr_thread_A_4_4th+3], v[vgpr_thread_B_4_4th+3]

s_waitcnt     lgkmcnt(0)
;//FMA_LOOP4
v_fmac_f32    v[vgpr_FMA_value], v[vgpr_thread_A_4_5th], v[vgpr_thread_B_4_5th]
v_fmac_f32    v[vgpr_FMA_value+1],v[vgpr_thread_A_4_5th+1], v[vgpr_thread_B_4_5th]
v_fmac_f32    v[vgpr_FMA_value+2],v[vgpr_thread_A_4_5th+2], v[vgpr_thread_B_4_5th]
v_fmac_f32    v[vgpr_FMA_value+3],v[vgpr_thread_A_4_5th+3], v[vgpr_thread_B_4_5th]
v_fmac_f32    v[vgpr_FMA_value+4], v[vgpr_thread_A_4_5th], v[vgpr_thread_B_4_5th+1]
v_fmac_f32    v[vgpr_FMA_value+5],v[vgpr_thread_A_4_5th+1], v[vgpr_thread_B_4_5th+1]
v_fmac_f32    v[vgpr_FMA_value+6],v[vgpr_thread_A_4_5th+2], v[vgpr_thread_B_4_5th+1]
v_fmac_f32    v[vgpr_FMA_value+7],v[vgpr_thread_A_4_5th+3], v[vgpr_thread_B_4_5th+1]
v_fmac_f32    v[vgpr_FMA_value+8], v[vgpr_thread_A_4_5th], v[vgpr_thread_B_4_5th+2]
v_fmac_f32    v[vgpr_FMA_value+9],v[vgpr_thread_A_4_5th+1], v[vgpr_thread_B_4_5th+2]
v_fmac_f32    v[vgpr_FMA_value+10],v[vgpr_thread_A_4_5th+2], v[vgpr_thread_B_4_5th+2]
v_fmac_f32    v[vgpr_FMA_value+11],v[vgpr_thread_A_4_5th+3], v[vgpr_thread_B_4_5th+2]
v_fmac_f32    v[vgpr_FMA_value+12], v[vgpr_thread_A_4_5th], v[vgpr_thread_B_4_5th+3]
v_fmac_f32    v[vgpr_FMA_value+13],v[vgpr_thread_A_4_5th+1], v[vgpr_thread_B_4_5th+3]
v_fmac_f32    v[vgpr_FMA_value+14],v[vgpr_thread_A_4_5th+2], v[vgpr_thread_B_4_5th+3]
v_fmac_f32    v[vgpr_FMA_value+15],v[vgpr_thread_A_4_5th+3], v[vgpr_thread_B_4_5th+3]


;//NOO LOOP 8 use 5th instead of 4th due to schedule
v_add_u32 v[vgpr_lds_A_offset],v[vgpr_lds_A_offset],s[sgpr_lds_NOO_offset];//64*4 
v_add_u32 v[vgpr_lds_B_offset],v[vgpr_lds_B_offset],s[sgpr_lds_NOO_offset]
...
LOOP_B_read_not_out_of_bound:
    s_or_saveexec_b64 s[sgpr_before_cmp_address:sgpr_before_cmp_address+1],exec
    v_cmpx_lt_u32 s[sgpr_tmp_cmp_positive:sgpr_tmp_cmp_positive+1], v[vgpr_global_k], s[sgpr_K]
